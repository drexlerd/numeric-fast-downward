...
public:
    ...
    std::list<std::pair<int, int>> &get_propositoinal_goals(int id_goal) { return propositional_goals[id_goal]; }
    ...
    std::list<int> &get_numeric_conditions_id(int pre_id) {
    ...
    std::string &get_proposition_name(int p_id) { return proposition_names[p_id]; }
    double get_small_m(int p_id) { return small_m[p_id]; }
    double get_epsilon(int p_id) { return epsilon[p_id]; }
    std::set<int> &get_mutex_actions(int op_id) { return mutex_actions[op_id]; }
